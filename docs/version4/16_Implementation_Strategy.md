...
*   Aggressively delete all code related to license checks, paid tier enforcement, telemetry, and proprietary SSO integrations.
*   Refactor the core to ensure it compiles without these dependencies.

## 2. Infrastructure Democratization
*   Extract the formerly proprietary "Enterprise Relay" code.
...
*   Convert legacy Enterprise Audit Logging into a local, encrypted SQLite log available to all users.
