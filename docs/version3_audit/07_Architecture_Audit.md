...
However, the architecture completely failed to incorporate the required Community SSO middleware and Identity Management directory servers defined in the official Research Roadmap.
