# QuickChat
The Decentralized, Secure, Peer-to-Peer Terminal Communicator

[![Rust](https://img.shields.io/badge/rust-1.80.0%2B-blue.svg)](https://www.rust-lang.org) [![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT) [![GitHub release (latest by date)](https://img.shields.io/github/v/release/aaryanrwt/QuickChat)](https://github.com/aaryanrwt/QuickChat/releases) [![GitHub repo size](https://img.shields.io/github/repo-size/aaryanrwt/QuickChat)](https://github.com/aaryanrwt/QuickChat) [![GitHub stars](https://img.shields.io/github/stars/aaryanrwt/QuickChat?style=social)](https://github.com/aaryanrwt/QuickChat/stargazers) [![GitHub forks](https://img.shields.io/github/forks/aaryanrwt/QuickChat?style=social)](https://github.com/aaryanrwt/QuickChat/network/members) [![GitHub contributors](https://img.shields.io/github/contributors/aaryanrwt/QuickChat)](https://github.com/aaryanrwt/QuickChat/graphs/contributors) [![GitHub issues](https://img.shields.io/github/issues/aaryanrwt/QuickChat)](https://github.com/aaryanrwt/QuickChat/issues) [![PRs Welcome](https://img.shields.io/badge/PRs-welcome-brightgreen.svg)](https://github.com/aaryanrwt/QuickChat/pulls) [![GitHub last commit](https://img.shields.io/github/last-commit/aaryanrwt/QuickChat)](https://github.com/aaryanrwt/QuickChat/commits/main) [![Platform Support](https://img.shields.io/badge/platform-Windows%20%7C%20Linux%20%7C%20macOS-lightgrey.svg)](https://github.com/aaryanrwt/QuickChat) [![Documentation](https://img.shields.io/badge/docs-latest-blue.svg)](https://github.com/aaryanrwt/QuickChat/tree/main/docs) [![Open Source Love](https://badges.frapsoft.com/os/v1/open-source.svg?v=103)](https://github.com/aaryanrwt/QuickChat) [![Made with Rust](https://img.shields.io/badge/Made%20with-Rust-orange.svg)](https://www.rust-lang.org) [![Cargo](https://img.shields.io/badge/cargo-stable-green.svg)](https://doc.rust-lang.org/cargo)
...
| Feature | Version 2 | Version 3 | Version 4 |
| :--- | :--- | :--- | :--- |
| **Networking** | LAN only | Global Internet routing | Fully Decentralized & Open |
| **Plugins** | Basic execution | WASI sandboxed, IPC host | Decentralized Git Registry |
| **Discovery (DHT)** | None (mDNS only) | Kademlia DHT integration | Global Kademlia DHT |
| **Relay** | None | quickchat_relay daemon | Open Community Relay Nodes |
| **Cryptography** | Noise_XX (1-on-1) | OpenMLS (Group CGKA) | Noise XX & MLS |
| **Persistence** | Ephemeral RAM only | Persistent local SQLite | Persistent local SQLite |
| **UI** | Single chat view | Multi-pane workspace | Multi-pane + AI Integration |
| **Commands** | Basic slash commands | Advanced `code://` pointers | + Offline AI Analysis Hooks |
| **Security** | TOFU Key Exchange | Sandboxed plugins & PFS | Zero-telemetry, offline privacy |
...
## 6. Quick Start
*   **Launch:** Run the executable. `quickchat_cli`
*   **Discover:** The DHT will automatically map local and global peers. Check your Contacts pane.
*   **Connect:** Use the `/connect` command with a peer's public key (displayed at the top of their UI).
*   **Message:** Type your message and hit Enter.
*   **Plugins:** Try sending a `code://file.rs:42` pointer to automatically trigger their local editor!
